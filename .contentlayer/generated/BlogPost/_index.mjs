...
import posts__usingClaudeCodeEnMdx from './posts__using-claude-code-en.mdx.json' with { type: 'json' }
import posts__usingClaudeCodeKoMdx from './posts__using-claude-code-ko.mdx.json' with { type: 'json' }
...
export const allBlogPosts = [posts__figmaConfig_2025EnMdx, posts__figmaConfig_2025KoMdx, posts__introduceEnMdx, posts__introduceKoMdx, posts__memoryOfCoffeeEnMdx, posts__memoryOfCoffeeKoMdx, posts__usingClaudeCodeEnMdx, posts__usingClaudeCodeKoMdx, posts__wifesLedgerEnMdx, posts__wifesLedgerKoMdx]
